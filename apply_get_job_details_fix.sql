-- Apply the get_job_details function fix
-- This script applies the updated get_job_details function with the new ceiling and accent wall fields
...
BEGIN
    ...
    -- Get billing category information
    SELECT 
        bc.id,
        bc.name
    INTO 
