-- =====================================================
-- SIMPLE FIX: Extra Charges Decline Functionality
-- =====================================================
-- Copy and run this entire script in Supabase SQL Editor
-- =====================================================

-- Add missing columns to approval_tokens table
...
BEGIN
  ...
  -- Log the decline (stays at same phase)
