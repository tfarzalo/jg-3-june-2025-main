-- Fix the get_upload_folder function
-- The issue is likely with parameter types or function logic
...
-- 3. Test the function with the specific property and job from the error
...
-- 4. Verify the returned folder IDs
