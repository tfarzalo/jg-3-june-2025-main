-- Complete Fix for Chat and Upload Functions
-- This script fixes both the missing start_dm function and get_upload_folder function
-- Includes all necessary helper functions

-- ============================================================================
-- PART 1: CHAT FUNCTIONS FIX
-- ============================================================================
...
-- Grant execute permissions to authenticated users for chat functions
...
-- ============================================================================
-- PART 2: FILE UPLOAD HELPER FUNCTIONS
-- ============================================================================

-- Create property folder structure function
...
-- Create work order folder structure function
...
-- ============================================================================
-- PART 3: FILE UPLOAD FUNCTIONS FIX
-- ============================================================================

-- Drop existing get_upload_folder function if it exists
DROP FUNCTION IF EXISTS get_upload_folder(uuid,uuid,text);

-- Create the get_upload_folder function
...
-- Grant execute permissions to authenticated users for upload functions
...
-- ============================================================================
-- PART 4: ENSURE CHAT TABLES EXIST
-- ============================================================================
