-- =====================================================
-- FIX FOR APPROVAL FUNCTION ERROR
-- =====================================================
...
-- Create the corrected function WITHOUT user_notifications
...
BEGIN
  ...
  -- Create a job phase change record
...
SELECT 'SUCCESS: process_approval_token function updated!' as status;
