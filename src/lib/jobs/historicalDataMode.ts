...
export const HISTORICAL_PHASES = new Set(['Completed', 'Invoicing', 'Cancelled', 'Archived']);
...
export function getHistoricalDataIndicator(
  ...
  return {
    ...
    label: 'Live',
    bgClass: 'bg-red-600',
    title: 'Live data: this completed, invoicing, cancelled, or archived job is still using mutable live data.',
  };
}
