...
export function Contacts() {
  ...
  const handleEditContact = (contact: Contact) => {
    ...
    setEditFormData({
      ...
      property_group: contact.property_group || '',
    ...
    try {
      const { error } = await supabase
        ...
        .update({
          ...
          property_group: editFormData.property_group,
  ...
  const handleDeleteContact = async () => {
    ...
    const confirmed = window.confirm(
      `Are you sure you want to delete ${selectedContact.first_name} ${selectedContact.last_name}? This action cannot be undone and will also delete all associated notes and communications.`
    );
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      {editingContact ? (
                        ...
                        <p className="text-gray-900 dark:text-white">{selectedContact.first_name}</p>
                      )}
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                      ...
                      {editingContact ? (
                        ...
                        <p className="text-gray-900 dark:text-white">{selectedContact.last_name}</p>
                      )}
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <div>
                      ...
                      {editingContact ? (
                        ...
                        <p className="text-gray-900 dark:text-white">{selectedContact.job_title}</p>
                      )}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      {editingContact ? (
                        ...
                        <p className="text-gray-900 dark:text-white">{selectedContact.property_name || 'No property name'}</p>
                      )}
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                      ...
                      {editingContact ? (
                        ...
                        <p className="text-gray-900 dark:text-white">{selectedContact.property_address || 'No property address'}</p>
                      )}
                    </div>
                    <div className="md:col-span-2">
                      ...
                      {editingContact ? (
                        <input
                          type="text"
                          value={editFormData.property_group}
                          onChange={(e) => setEditFormData({ ...editFormData, property_group: e.target.value })}
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                          placeholder="Enter property management group"
                        />
                      ) : (
                        <p className="text-gray-900 dark:text-white">{selectedContact.property_group || 'No property group'}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    <select
                      value={selectedContact.status_name}
                      onChange={(e) => {
                        const status = leadStatuses.find(s => s.name === e.target.value);
                        if (status) {
                          updateLeadStatus(selectedContact.lead_id, status.id);
                          setSelectedContact({
                            ...selectedContact,
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    <select
                      ...
                      onChange={(e) => {
                        updateContactAssignment(selectedContact.contact_id, e.target.value);
                        const user = users.find(u => u.id === e.target.value);
                        setSelectedContact({
                          ...selectedContact,
                          assigned_to: e.target.value,
                          assigned_to_name: user?.full_name || 'Unassigned'
                        });
                      }}
                      className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                    >
                ...
                <div>
                  ...
                  {editingContact ? (
                    ...
                    <textarea
                      value={selectedContact.contact_notes}
                      onChange={(e) => setSelectedContact({
                        ...selectedContact,
                        contact_notes: e.target.value
                      })}
                      onBlur={() => updateContactNotes(selectedContact.contact_id, selectedContact.contact_notes)}
                      rows={4}
                ...
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      <strong>Source Form:</strong> {selectedContact.form_name}
                    </p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      <strong>Created:</strong> {new Date(selectedContact.lead_created_at).toLocaleString()}
                    </p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      <strong>Assigned to:</strong> {selectedContact.assigned_to_name}
                    </p>
                  </div>
                </div>
              </div>
