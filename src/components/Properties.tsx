        ...
        <div className="flex space-x-3">
          {canUsePinnedWorkspace && (
            <button
              ...
              title={isPinned(`list:${location.pathname}:${activeTab}`) ? 'Pinned List Summary' : 'Pin List Summary'}
              aria-label={isPinned(`list:${location.pathname}:${activeTab}`) ? 'Pinned List Summary' : 'Pin List Summary'}
            >
