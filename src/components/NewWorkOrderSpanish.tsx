...
const NewWorkOrderSpanish: React.FC<NewWorkOrderSpanishProps> = ({
  ...
  const requiredFieldsFilled = Boolean(
    ...
    // Check if sprinkler images are uploaded when sprinklers are enabled
    (!formData.sprinklers || (formData.sprinklers && sprinklerImagesUploaded)) &&
    // Check if extra charges fields are filled when extra charges is enabled
      ...
      {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-lg p-6 shadow">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Información de la Unidad</h2>
              ...
              <div>
                ...
                {isSubcontractor && (
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Este campo fue configurado durante la configuración del trabajo y no se puede editar
                  </p>
                )}
              </div>
          ...
          {/* Sprinklers */}
          <div className="bg-white dark:bg-[#1E293B] rounded-lg p-6 shadow">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Aspersores</h2>
                ...
                <>
                  ...
                  <div className="mt-4">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Imágenes de Aspersores <span className="text-red-500">*</span>
                    </label>
                    <ImageUpload
                      jobId={job.id}
          ...
          {/* Before Images */}
          <div className="bg-white dark:bg-[#1E293B] rounded-lg p-6 shadow">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Imágenes de Antes</h2>
          ...
          {/* Other Files */}
          <div className="bg-white dark:bg-[#1E293B] rounded-lg p-6 shadow">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Otros Archivos</h2>
          ...
          {/* Painted Items */}
          <div className="bg-white dark:bg-[#1E293B] rounded-lg p-6 shadow">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Elementos Pintados</h2>
                ...
                {formData.painted_ceilings && (
                  <div className="ml-6">
                    <label htmlFor="ceiling_rooms_count" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                      Número de Techos <span className="text-red-500">*</span>
                    </label>
                        ...
                        {formData.ceiling_rooms_count === 'individual' && (
                          <div className="mt-3">
                            <label htmlFor="individual_ceiling_count" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                              ¿Cuántos techos individuales? <span className="text-red-500">*</span>
                            </label>
                            <input
                              type="number"
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <label htmlFor="accent_wall_type" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                    Tipo de Pared de Acento <span className="text-red-500">*</span>
                  </label>
                ...
                <div>
                  <label htmlFor="accent_wall_count" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                    Número de Paredes de Acento <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="number"
          ...
          {/* Additional Comments */}
          <div className="bg-white dark:bg-[#1E293B] rounded-lg p-6 shadow">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Comentarios Adicionales</h2>
