-- Apply the get_job_details function fix - Version 5
-- This script fixes the job_phase column name issue (jp.name -> jp.job_phase_label)

-- Drop and recreate the function with the corrected column references
