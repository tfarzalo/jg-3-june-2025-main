/*
  ...
  1. Changes
    - Drop billing_unit_sizes table and use existing unit_sizes table
...
-- Drop billing_unit_sizes table and its dependencies if they exist
DO $$ BEGIN
  ALTER TABLE IF EXISTS billing_details DROP CONSTRAINT IF EXISTS billing_details_unit_size_id_fkey;
  DROP TABLE IF EXISTS billing_unit_sizes CASCADE;
EXCEPTION
  WHEN undefined_object THEN NULL;
END $$;
