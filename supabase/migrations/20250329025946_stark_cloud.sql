/*
  # Fix Billing Categories Property Scoping

  1. Changes
    - Add property_id to billing_categories table
    - Update unique constraint to include property_id
    - Remove default categories insertion
    - Update RLS policies to enforce property-level access
    
  2. Security
    - Maintain RLS enabled
    - Update policies to check property ownership
*/
...
CREATE INDEX idx_billing_categories_property_id ON billing_categories(property_id);
