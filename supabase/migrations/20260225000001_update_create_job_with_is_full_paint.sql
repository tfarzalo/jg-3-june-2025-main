/*
  Update create_job RPC function to accept and store is_full_paint field
  
  This allows the job request form to set the paint type at job creation,
  which will automatically propagate to work orders.
*/
...
CREATE OR REPLACE FUNCTION create_job(
  ...
  p_is_full_paint boolean DEFAULT true
)
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
