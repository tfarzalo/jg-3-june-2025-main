-- Fix work order user lookup using a safe, simple subquery
-- We must include the full function definition to update it, but we are only changing 2 lines in the work_order section.
...
BEGIN
    ...
    -- Get work order data
    -- We use a direct subquery to get the submitted_by_name to avoid complex joins
