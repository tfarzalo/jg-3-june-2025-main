-- Override legacy activity trigger functions to ensure WO-###### format and property/unit context

-- Job creation trigger override
...
-- Job phase change trigger override
