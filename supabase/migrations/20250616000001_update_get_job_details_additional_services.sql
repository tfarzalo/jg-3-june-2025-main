-- Update get_job_details function to include additional_services in the work_order object
-- This ensures that dynamic additional services are properly returned to the frontend
