/*
  # Fix Billing Schema to Start Empty

  1. Changes
    - Drop existing tables and recreate with clean slate
    - Remove any default data insertion
    - Keep schema structure but start empty
