-- Merge duplicate property folders by property_id (UUID), keep most recently used
...
BEGIN
  ...
  -- Re-parent children of duplicate folders to the keeper
  UPDATE files f
  SET folder_id = k.id
  FROM dupes d
  ...
  -- Remove duplicate property root folders
  DELETE FROM files
