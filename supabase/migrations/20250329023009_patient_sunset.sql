/*
  ...
  1. Changes
    - Remove all default categories and items
    - Keep tables and policies but remove default data
...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Enable delete for authenticated users" ON billing_categories;
  ...
  DROP POLICY IF EXISTS "Enable delete for authenticated users" ON billing_details;
