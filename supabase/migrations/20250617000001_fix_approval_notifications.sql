-- Fix approval token processing to create proper job phase changes for notifications
-- This ensures that approvals create both notifications AND trigger phase change notifications
...
BEGIN
  ...
  -- This will automatically trigger the existing notification system
