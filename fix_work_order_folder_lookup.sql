-- Fix the create_work_order_folder_structure function to use robust folder lookup
-- This fixes the "Work Orders folder not found for property" error
...
-- Test the fix
SELECT 'Function updated successfully - the Work Orders folder lookup now uses property_id and name instead of just path' as status;
