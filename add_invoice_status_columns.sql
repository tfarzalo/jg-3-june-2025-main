...
-- This script adds the necessary columns to track invoice sent and paid status

-- Add invoice status columns if they don't exist
DO $$ 
BEGIN
...
-- Update the get_job_details function to include invoice status fields
